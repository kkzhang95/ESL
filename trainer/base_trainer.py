...
class BaseTrainer:
    ...
    def train(self):
        for epoch in range(self.start_epoch, self.num_epochs + 1):
            ...
            if epoch % self.config.save_every == 0:
                    self._save_checkpoint(epoch, self.config, save_best=False)
    ...
    def _save_checkpoint(self, epoch, config, save_best=False):
        """
        Saving checkpoints
        :param epoch: current epoch number
    ...
    def load_checkpoint(self, checkpoint_path):
        ...
        # checkpoint_path = '/mnt/data10t/bakuphome20210617/zhangkun/xpool_flik/outputs/replicate/model_best.pth'
        # checkpoint_path = '/mnt/data10t/bakuphome20210617/zhangkun/xpool_flik/outputs/replicate/model_best_565.5.pth'
        # checkpoint_path = '/mnt/data10t/bakuphome20210617/zhangkun/xpool_flik/outputs/replicate/model_best_565.9.pth'
