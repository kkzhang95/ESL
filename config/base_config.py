...
class Config(ABC):
    def __init__(self):
        ...
        self.mean_neg = args.mean_neg
        self.stnd_neg = args.stnd_neg
        self.mean_pos = args.mean_pos
        self.stnd_pos = args.stnd_pos
        self.thres = args.thres
        self.thres_safe = args.thres_safe
        self.alpha = args.alpha
        self.in_training = args.in_training

        self.thres_entity = args.thres_entity
        self.thres_safe_entity = args.thres_safe_entity
        self.center_entity = args.center_entity
        self.center_non_entity = args.center_non_entity
